...
export default function StaffLayout() {
  ...
  const tabs = [
    { name: "Employee Directory", path: "/staff/directory" },
    { name: "Timesheets", path: "/staff/timesheets" },
    { name: "Role Builder", path: "/staff/roles" },
  ];
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-4">
          <div>
            ...
            <p className="text-sm text-slate-500 dark:text-zinc-400 mt-1">
              Onboard employees, configure salaries, manage timesheets, and set role-based permissions.
            </p>
          </div>
        </div>
