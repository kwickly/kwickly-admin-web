import { Plus, Target, MessageSquare, Send, Calendar } from "lucide-react";
import { useState } from "react";
import { useSegments, useCreateSegment, useCampaigns, useCreateCampaign } from "@/hooks/api/useCRM";
    ...
    <div className="max-w-7xl mx-auto space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-sm text-slate-500 dark:text-zinc-400 mt-1">
            Segment your customer base and trigger automatic WhatsApp, push, and SMS promotions.
          </p>
        </div>
      </div>
      ...
      <Tabs defaultValue="segments" className="w-full">
        <TabsList className="bg-slate-100 dark:bg-zinc-900/50 p-1 border border-slate-200 dark:border-zinc-800 rounded-lg mb-6">
          <TabsTrigger value="segments" className="rounded-md data-[state=active]:bg-white data-[state=active]:dark:bg-zinc-800 data-[state=active]:text-indigo-600 data-[state=active]:dark:text-indigo-400 data-[state=active]:shadow-sm">
            Customer Segments
          </TabsTrigger>
          <TabsTrigger value="campaigns" className="rounded-md data-[state=active]:bg-white data-[state=active]:dark:bg-zinc-800 data-[state=active]:text-indigo-600 data-[state=active]:dark:text-indigo-400 data-[state=active]:shadow-sm">
            Campaign Logs & Dispatcher
          </TabsTrigger>
        </TabsList>

        <TabsContent value="segments" className="mt-0 outline-none space-y-6">
          <div className="flex justify-between items-center">
            <h2 className="text-lg font-semibold text-slate-900 dark:text-zinc-100">Configured Segments</h2>
        ...
        <TabsContent value="campaigns" className="mt-0 outline-none space-y-6">
          <div className="flex justify-between items-center">
            <h2 className="text-lg font-semibold text-slate-900 dark:text-zinc-100">Dispatched Campaigns</h2>
