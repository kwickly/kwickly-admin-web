    ...
    <div className="max-w-7xl mx-auto space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-sm text-slate-500 dark:text-zinc-400 mt-1">
            Track raw ingredients, view current stock levels, and set low-stock alerts.
          </p>
        </div>
      </div>
      ...
      <div className="flex items-center justify-center h-64 border border-dashed border-slate-300 dark:border-zinc-800 rounded-xl bg-slate-50 dark:bg-zinc-900/50">
        <div className="text-center">
          ...
          <h3 className="text-lg font-medium text-slate-900 dark:text-white">Inventory Module Setup</h3>
          <p className="text-sm text-slate-500 dark:text-zinc-400 mt-1 max-w-sm">
            Inventory tracking is currently being initialized. Please check back later.
          </p>
        </div>
      </div>
    </div>
