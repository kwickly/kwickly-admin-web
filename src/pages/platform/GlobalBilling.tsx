...
export default function GlobalBilling() {
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700 ease-out">
      <PageHeader
        title="Global Billing & Revenue"
        description="Monitor MRR, handle failed SaaS subscriptions, and manage platform pricing tiers."
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="p-6 border border-border rounded-xl bg-card">
          <div className="flex items-center justify-between">
            ...
            <Icons.DollarSign className="h-4 w-4 text-success" />
          </div>
        ...
        <div className="p-6 border border-border rounded-xl bg-card">
          <div className="flex items-center justify-between">
            ...
            <Icons.CreditCard className="h-4 w-4 text-secondary" />
          </div>
      ...
      <div className="flex items-center justify-center h-64 border border-dashed border-border rounded-xl bg-card/50">
        <div className="text-center">
          <Icons.CreditCard className="h-10 w-10 text-muted-foreground/50 mx-auto mb-4" />
